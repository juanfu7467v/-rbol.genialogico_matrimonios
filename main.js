...
app.get("/descargar-arbol-pdf", async (req, res) => {
    ...
    try {
        ...
        doc.addPage();
        drawHeader(doc, "RESUMEN ESTADISTICO DINAMICO");
        ...
        doc.fontSize(14).text("Distribucion por Genero", 40, 130);
        ...
        doc.fillColor("#145A32").fontSize(11).text("NIVEL DE VERIFICACION DE RELACIONES: ALTA", 60, 440);

        doc.rect(40, 650, 532, 90).fill("#F2F3F4");
        doc.fillColor("#7F8C8D").fontSize(8).font("Helvetica-Oblique");
        const disclaimer = [
            "1. Esta plataforma actua unicamente como intermediaria de consulta.",
            "2. La informacion proviene integramente de fuentes y APIs externas.",
            ...
            "5. La informacion es meramente referencial y no tiene validez legal de acta de nacimiento."
        ];
